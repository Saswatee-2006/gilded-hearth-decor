...
export const ARTICLES: Article[] = [
  {
    ...
    content: [
      ...
      {
        heading: "Understand the Light",
        text: "Before looking at paint swatches, look at your windows. The amount and direction of natural light in a room completely alters how a colour appears. North-facing rooms receive cool light and benefit from warm undertones. South-facing rooms are flooded with warm light and can handle cooler tones.",
      },
      {
        heading: "The 60-30-10 Rule",
        text: "When building a palette, interior designers often rely on the 60-30-10 rule. 60% of the room should be your dominant colour, 30% should be the secondary colour, and 10% should be your accent colour.",
      },
      {
  ...
  },
  {
    ...
    category: "SPACES",
    blurb:
      "Simple decisions around light, scale, and furniture placement can change a compact space.",
    image:
    ...
    content: [
      ...
      },
      {
        ...
        text: "A common mistake in small spaces is buying lots of small furniture. This actually makes the room look cluttered. Instead, opt for fewer, larger pieces. A single, substantial sofa will make a living room feel larger than a loveseat paired with small armchairs.",
      },
      {
        heading: "The Power of Mirrors",
        text: "It is the oldest trick in the book for a reason. Mirrors bounce natural light deep into a room and create the illusion of depth. Place a large mirror opposite your biggest window to immediately double the perceived brightness.",
      },
      {
  ...
  },
  {
    ...
    content: [
      ...
      {
        heading: "Wood as an Anchor",
        text: "Wood is unparalleled in its ability to bring warmth. The organic grain of wood softens the harsh straight lines typical of modern architecture. Do not be afraid to mix wood tones; a curated blend of walnut, ash, and oak looks sophisticated.",
      },
      {
        heading: "Tactile Textiles",
        text: "Linen, wool, and jute offer sensory richness. A rumpled linen throw draped over a crisp leather sofa creates a beautiful tension. Similarly, a chunky wool rug anchors a room physically and visually, absorbing sound and adding comfort.",
      },
      {
  ...
  },
  {
    ...
    content: [
      ...
      {
        heading: "Embrace the Void",
        text: "The most important element of minimalist styling is negative space. You do not need to fill every corner, every shelf, or every wall. Allowing empty space around a beautiful piece of furniture gives it breathing room.",
      },
      {
        heading: "Restrain Your Palette",
        text: "A calm space relies on a cohesive, subdued color palette. Layer warm ivories, soft sands, and muted greys. When you do introduce color, do it through natural elements like green plants or art in earthy tones.",
      },
      {
  ...
  },
  {
    ...
    category: "STYLING",
    blurb:
      "Small changes in layout, lighting and accessories can make a room feel completely different.",
    image:
    ...
    content: [
      ...
      },
      {
        ...
        text: "The instinct in many homes is to push every piece of furniture flat against the walls. Try pulling the sofa forward by even six inches. 'Floating' furniture creates intimate conversation areas and improves flow.",
      },
      {
        heading: "Re-Style the Coffee Table",
        text: "Clear your coffee table completely. Start fresh. Place a large tray down as a base. Add a stack of books, a sculptural object, and a small vase. This simple vignette elevates the entire center of the room.",
      },
      {
  ...
  },
  {
    ...
    content: [
      ...
      {
        heading: "Prioritize Silhouette Over Embellishment",
        text: "Luxury lies in the lines. A simple, beautifully proportioned sofa in a plain fabric will always look more expensive than a heavily tufted, over-embellished piece. Look for clean, strong silhouettes.",
      },
      {
        heading: "The Magic of Monochromatic Layering",
        text: "One of the easiest ways to elevate a room is tone-on-tone layering. A bedroom featuring ivory walls, cream sheets, and beige curtains feels incredibly sophisticated. The lack of high-contrast colours forces the eye to appreciate subtle textures.",
      },
      {
