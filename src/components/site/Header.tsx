              ...
              <nav className="mt-8 flex flex-col pb-8">
                <div className="flex flex-col py-2">
                  ...
                  <Link
                    ...
                    className={cn(
                      "flex items-center justify-between rounded-md px-2 py-3 transition-colors hover:bg-accent/50",
                  ...
                  <Link
                    ...
                    className="flex items-center justify-between rounded-md px-2 py-3 transition-colors hover:bg-accent/50"
                  >
                    <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="flex w-full items-center justify-between rounded-md px-2 py-3 transition-colors hover:bg-accent/50 text-left"
                  >
                    <div className="flex items-center gap-3">
                  ...
                  <Link
                    to="/wishlist"
                    onClick={(e) => handleMobileNav(e, "/wishlist")}
                    className="flex items-center justify-between rounded-md px-2 py-3 transition-colors hover:bg-accent/50"
                  >
                    <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col py-2">
                  ...
                  <Link
                    ...
                    onClick={(e) => handleMobileNav(e, user ? "/account" : "/auth")}
                    className="flex items-center justify-between rounded-md px-2 py-3 transition-colors hover:bg-accent/50"
                  >
                    <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col py-2">
                  ...
                  <Link
                    to="/faqs"
                    onClick={(e) => handleMobileNav(e, "/faqs")}
                    className="flex items-center justify-between rounded-md px-2 py-3 transition-colors hover:bg-accent/50"
                  >
                    <div className="flex items-center gap-3">
                  ...
                  <Link
                    to="/track-order"
                    onClick={(e) => handleMobileNav(e, "/track-order")}
                    className="flex items-center justify-between rounded-md px-2 py-3 transition-colors hover:bg-accent/50"
                  >
                    <div className="flex items-center gap-3">
        ...
        <div className="flex items-center">
          ...
          <Link to="/" className="flex items-center gap-2 md:gap-3 shrink-1 min-w-0">
            ...
            <div className="flex flex-col leading-none shrink-1 min-w-0">
              <span className="font-display text-xl tracking-wide md:text-[28px] truncate">
                Aarohan
              </span>
        ...
        {isHomePage && (
          <nav className="ml-6 hidden flex-1 items-center gap-6 lg:flex">
            ...
            <Link
              ...
              className={cn("link-underline text-sm", location.pathname === "/" && "text-accent")}
            >
              Home
            </Link>
            <Link
        ...
        <div className="ml-auto flex items-center gap-0 sm:gap-1 shrink-0">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56 mt-2 rounded-xl p-2">
              {!user ? (
                <>
                  <DropdownMenuLabel className="eyebrow px-2 py-2 text-xs">
                    Account Access
                  </DropdownMenuLabel>
                  <DropdownMenuItem
                    asChild
                    className="cursor-pointer rounded-lg focus:bg-accent/10 focus:text-accent"
                  >
